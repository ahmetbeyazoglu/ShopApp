...
import com.herpestes.myshoppal.activities.UserProfileActivity
...
class FireStoreClass {
    ...
    fun placeOrder(activity: CheckoutActivity, orderDetails: StructuredQuery.Order) {
    ...
    fun updateAllDetails(activity: CheckoutActivity, cartList: ArrayList<CartItem>, order: StructuredQuery.Order) {
    ...
    fun getMyOrderList(fragment: OrdersFragment) {
        mFireStore.collection(Constants.ORDERS)
            ...
            .get()
            .addOnSuccessListener { document ->
                val list: ArrayList<StructuredQuery.Order> = ArrayList()
                for (i in document.documents) {
                    val orderDetails = i.toObject(StructuredQuery.Order::class.java)
